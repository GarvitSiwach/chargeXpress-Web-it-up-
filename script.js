...
document.querySelector("#Submit").addEventListener("click", function(event) {
  ...
  const showLoginButton = document.querySelector("#show-login");
    showLoginButton.innerHTML = `<img src="icons8-male-user-50.png" alt="Profile Icon" />`;
...
document.querySelector("#location").addEventListener("click", function () {
  document.querySelector(".popup_location").classList.add("active");
});
document.querySelector(".popup_location .close-btn").addEventListener("click",function(){
  document.querySelector(".popup_location").classList.remove("active");
});